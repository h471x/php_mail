<?php
  ...
  try {
    ...
    $signup_error = '<span class="signup-tooltip"  id="status_connected">Connected</span>
    ...
    if (strpos($error_message, 'SQLSTATE[HY000] [2002]') !== false) {
        ...
        $signup_error = '<span class="signup-tooltip" id="status_disconnected">Disconnected</span>
        ...
        $signup_error = '<span class="signup-tooltip"  id="status_denied">Access Denied</span>
        <span class="signup-tooltip"  id="status_connected" style="visibility: hidden;">Connected</span>
        <span class="signup-tooltip" id="status_disconnected"style="visibility: hidden;">Disconnected</span>
        <span class="signup-tooltip"  id="status_issue" style="visibility: hidden;">Server Issue</span>';
